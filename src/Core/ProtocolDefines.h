...
/// The `Exception` packet uses the versioned `StructuredException` payload instead of the legacy positional fields.
static constexpr auto DBMS_MIN_REVISION_WITH_STRUCTURED_EXCEPTION = 54492;
